...
| 131 | Discovery-To-Loop Promotion Boundary v1 | In Review | Define the source-only review gate, required evidence, stop conditions, and next staged promotion levels before any runtime, scheduler, paper, Alpaca, broker, or order exposure. |

## Current Recommendation

Review **Discovery-To-Loop Promotion Boundary v1**, then decide whether the
next stage should be a source-only promotion review or a runtime-clone
no-network rehearsal design. Do not expose launchd, runtime deployment,
