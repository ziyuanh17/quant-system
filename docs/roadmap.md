...
Review **Semantic-Target Alpaca Paper Inline Verification Report v1**, then decide
...
readiness evidence before the order-capable run. Do not expose launchd, add
