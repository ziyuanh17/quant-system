...
client, and a fake-backed live adapter now exist. The next milestone should
reconcile local live artifacts against fake broker truth before any real broker
SDK integration.
