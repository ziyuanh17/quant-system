...
The MacBook Air recurring schedule intentionally remains active until milestone
M10. This avoids a service gap while preventing duplicate scheduled execution.
